...
type ServerForm struct {
	...
	Account             string              `json:"account,omitempty" validate:"optional"`        // 账号信息
	ExpiredAt           *time.Time          `json:"expired_at,omitempty" validate:"optional"`     // 到期时间
	PurchasePrice       *float64            `json:"purchase_price,omitempty" validate:"optional"` // 购买价格
	PurchaseDate        *time.Time          `json:"purchase_date,omitempty" validate:"optional"`  // 购买日期
	PurchaseYears       *uint32             `json:"purchase_years,omitempty" validate:"optional"` // 购买年限
	MonthlyTraffic      *uint64             `json:"monthly_traffic,omitempty" validate:"optional"`
